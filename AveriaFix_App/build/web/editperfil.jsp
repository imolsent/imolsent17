        ...
        <div class="container-fluid flex-grow-1 d-flex flex-column">
            ...
            <div class="navegador">
                <div class="menu-navegador">
                    <a href="perfil.jsp"><button class="avrmen"><img src="recursos/verav b.png" alt="Ver" class="iconoopc"></button></a>
                    <button class="avrmen selected"><img src="recursos/editar w.png" alt="Editar" class="iconoopc"></button>
                </div>
                <div class="titulo-navegador">Editar</div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="Información de la base de datos" class="info-input-add">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" value="contraseña" class="info-input-add">
                                </div>

                                <div class="mb-3">
                                    <label class="subtitulo">Confirmar contraseña</label>
                                    <input type="password" value="contraseña" class="info-input-add">
                                </div>
                            </div>
